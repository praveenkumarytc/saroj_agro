        ...
        children: [
          ...
          Container(
            ...
            constraints: BoxConstraints(
              minHeight: preferredSize.height * 0.5,
            ),
            child: Center(
              child: SizedBox(
                  width: 1170,
                      ...
                      Row(children: [
                        ...
                        TextHover(builder: (isHovered) {
                          return InkWell(
                            ...
                            child: Text('home'.tr, style: isHovered ? poppinsSemiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge) : poppinsMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeLarge)),
                          );
                        }),
                        const SizedBox(width: 30),
                        TextHover(builder: (isHovered) {
                          return MouseRegion(
                            ...
                            child: Row(children: [
                              Text(
                                'categories'.tr,
                                style: isHovered ? poppinsSemiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge) : poppinsMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeLarge),
                              ),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                      ...
                      Row(children: [
                            ...
                            return CustomTextField(
                              ...
                              onSuffixTap: () {
                                if (search.searchController.text.isNotEmpty && search.isSearch == true) {
                                  Navigator.pushNamed(context, RouteHelper.getSearchResultRoute(search.searchController.text), arguments: SearchResultScreen(searchString: search.searchController.text));
                                  search.searchDone();
                        ...
                        OnHover(
                          ...
                          child: Consumer<WishListProvider>(
                              builder: (context, wishListProvider, _) => CountView(
                        ...
                        OnHover(
                          ...
                          child: Consumer<CartProvider>(
                              builder: (context, cartProvider, _) => CountView(
