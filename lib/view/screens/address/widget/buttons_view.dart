    ...
    return Column(children: [
      locationProvider.addressStatusMessage != null
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.green, height: 1),
                  ),
                )
              ],
            )
          : Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                locationProvider.errorMessage!.isNotEmpty ? const CircleAvatar(backgroundColor: Colors.red, radius: 5) : const SizedBox.shrink(),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    ...
                    : () {
                        ...
                        if (!isAvailable) {
                          ...
                          AddressModel addressModel = AddressModel(
                            ...
                            latitude: isEnableUpdate ? locationProvider.position.latitude.toString() : locationProvider.position.latitude.toString(),
