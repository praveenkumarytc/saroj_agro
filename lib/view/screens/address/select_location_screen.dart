...
class _SelectLocationScreenState extends State<SelectLocationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(prefferedSized), child: WebAppBar()) : CustomAppBar(title: getTranslated('select_delivery_address', context), isCenter: true)) as PreferredSizeWidget?,
      body: Center(
        child: SizedBox(
          width: 1170,
          child: Consumer<LocationProvider>(
            builder: (context, locationProvider, child) => Stack(
              ...
              children: [
                ...
                locationProvider.loading ? Center(child: CustomLoader(color: Theme.of(context).primaryColor)) : const SizedBox(),
              ],
            ),
          ),
        ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          Expanded(
              child: Text(
            locationProvider.pickAddress != null && locationProvider.pickAddress!.isNotEmpty ? locationProvider.pickAddress! : getTranslated('search_here', context),
            maxLines: 1,
