  ...
  Widget build(BuildContext context) {
    return Consumer<SplashProvider>(builder: (context, splashProvider, child) {
      return RefreshIndicator(
        ...
        child: Scaffold(
          appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(80), child: WebAppBar()) : null,
              ...
              child: Column(children: [
                ...
                if (splashProvider.configModel!.flashDealProductStatus!)
                  Consumer<FlashDealProvider>(builder: (context, flashDealProvider, child) {
                    return flashDealProvider.flashDealModel != null && flashDealProvider.flashDealModel!.products != null && flashDealProvider.flashDealModel!.products!.isEmpty
                        ? const SizedBox()
                        : Column(children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.only(
                                  left: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeDefault : 0,
                                  top: Dimensions.paddingSizeDefault,
                                  bottom: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeDefault : Dimensions.paddingSizeSmall,
                                ),
