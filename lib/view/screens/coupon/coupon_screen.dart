              ...
              builder: (context, couponProvider, child) {
                return couponProvider.couponList != null
                    ? couponProvider.couponList!.isNotEmpty
                                                        ...
                                                        child: Row(children: [
                                                          ...
                                                          Expanded(
                                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                                              ...
                                                              Text(
                                                                couponProvider.couponList![index].couponType == 'free_delivery' ? getTranslated('free_delivery', context) : '${couponProvider.couponList![index].discount}${couponProvider.couponList![index].discountType == 'percent' ? '%' : Provider.of<SplashProvider>(context, listen: false).configModel!.currencySymbol} off',
                        ...
                        : NoDataScreen(title: getTranslated('coupon_not_found', context))
