                  ...
                  builder: (context, authProvider, child) => Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: width > 850 ? 450 : 45, vertical: 35),
                          child: TextFormField(
                            textAlign: TextAlign.center,
                            ...
                            onChanged: (query) {
                              authProvider.updateVerificationCode(query, 6);
                            },
                            maxLength: 6,
                                ...
                                : TextButton(
                                    ...
                                    child: Builder(builder: (context) {
                                      ...
                                      return CustomDirectionality(
                                        child: Text((authProvider.currentTime != null && authProvider.currentTime! > 0) ? '${getTranslated('resend', context)} (${minutes > 0 ? '${minutes}m :' : ''}${seconds}s)' : getTranslated('resend_it', context),
                                            textAlign: TextAlign.end,
                                            style: poppinsMedium.copyWith(
                                              color: authProvider.currentTime != null && authProvider.currentTime! > 0 ? Theme.of(context).disabledColor : Theme.of(context).primaryColor.withOpacity(.6),
                                            )),
                                      );
                                    })),
                          ],
