...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(prefferedSized), child: WebAppBar()) : CustomAppBar(title: getTranslated('forgot_password', context))) as PreferredSizeWidget?,
      body: Center(
                ...
                builder: (context, auth, child) {
                  return Column(
                    children: [
                      ...
                      Center(
                          child: Text(
                        getTranslated(configModel.phoneVerification! ? 'please_enter_your_number' : 'please_enter_your_email', context),
