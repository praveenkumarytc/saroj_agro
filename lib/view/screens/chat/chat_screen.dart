    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : ResponsiveHelper.isMobilePhone() && isAdmin && !widget.isAppBar
              ? null
              : AppBar(title: isAdmin ? Text('${Provider.of<SplashProvider>(context, listen: false).configModel!.ecommerceName}') : Text('${widget.orderModel!.deliveryMan!.fName!} ${widget.orderModel!.deliveryMan!.lName!}'), backgroundColor: Theme.of(context).primaryColor, actions: <Widget>[
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Container(
                      width: 40,
                      height: 40,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(50), border: Border.all(width: 2, color: Theme.of(context).cardColor), color: Theme.of(context).cardColor),
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          imageErrorBuilder: (c, t, o) => Image.asset(
                            isAdmin ? Images.appLogo : Images.profilePlaceholder,
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
