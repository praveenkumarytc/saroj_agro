  ...
  void initState() {
    ...
    if (widget.productType != ProductType.flashSale) {
      ...
      scrollController.addListener(() {
        if (scrollController.position.maxScrollExtent == scrollController.position.pixels && (productProvider.dailyItemList != null) && !productProvider.isLoading) {
            ...
            children: [
              ConstrainedBox(
                ...
                child: Column(children: [
                  ...
                  SizedBox(
                      width: 1170,
                      child: Consumer<FlashDealProvider>(builder: (context, flashDealProvider, child) {
                          ...
                          builder: (context, productProvider, child) {
                            ...
                            return productList != null
                                ? productList.isNotEmpty
                                    ...
                                    : NoDataScreen(title: getTranslated('product_not_found', context))
                                : SizedBox(height: MediaQuery.of(context).size.height * 0.5, child: Center(child: CustomLoader(color: Theme.of(context).primaryColor)));
                          },
                        );
                      })),
