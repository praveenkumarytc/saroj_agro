...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(prefferedSized), child: WebAppBar()) : DetailsAppBar(key: UniqueKey(), title: 'product_details'.tr),
        ...
        return Consumer<ProductProvider>(
          builder: (context, productProvider, child) {
            ...
            if (productProvider.product != null) {
              ...
              cartModel = CartModel(productProvider.product!.id, productProvider.product!.image!.isNotEmpty ? productProvider.product!.image![0] : '', productProvider.product!.name, price, priceWithDiscount, productProvider.quantity, variation, (price! - priceWithDiscount!), (price - PriceConverter.convertWithDiscount(price, productProvider.product!.tax, productProvider.product!.taxType)!), productProvider.product!.capacity, productProvider.product!.unit, stock, productProvider.product);
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          SizedBox(
                                            height: 60,
                                            child: productProvider.product!.image != null ? SelectedImageWidget(productModel: productProvider.product) : const SizedBox(),
                                          ),
                                                ...
                                                return Container(
                                                  ...
                                                  child: Row(children: [
                                                    ...
                                                    Consumer<CartProvider>(builder: (context, cart, child) {
                                                      return Text(productProvider.cartIndex != null ? cart.cartList[productProvider.cartIndex!].quantity.toString() : productProvider.quantity.toString(), style: poppinsBold.copyWith(color: Theme.of(context).primaryColor));
                                                    }),
                                                    const SizedBox(width: 15),
                                                    QuantityButton(
                                                      isIncrement: true,
                                                      ...
                                                      child: Consumer<CartProvider>(builder: (context, cartProvider, child) {
                                                        return CustomZoomWidget(
                                                          image: ClipRRect(
                                                            ...
                                                            child: CustomImage(
                                                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.productImageUrl}/${productProvider.product!.image!.isNotEmpty ? productProvider.product!.image![cartProvider.productSelect] : ''}',
                                                              fit: BoxFit.cover,
                                                            ),
                                                          ),
                                                        );
        ...
        _tabIndex == 0
            ? Stack(
                children: [
                  ...
                  if (productProvider.product!.description != null && productProvider.product!.description!.length > (ResponsiveHelper.isDesktop(context) ? 700 : 300) && showSeeMoreButton)
                    Positioned.fill(
                        child: Align(
            ...
            : Column(children: [
                SizedBox(
                  ...
                  child: Column(children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text('${productProvider.product!.rating!.isNotEmpty ? double.parse(productProvider.product!.rating!.first.average!).toStringAsFixed(1) : 0.0}',
                        ...
                        RatingBar(
                          rating: productProvider.product!.rating!.isNotEmpty ? double.parse(productProvider.product!.rating![0].average!) : 0.0,
                          size: 25,
                        ),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return productProvider.product!.activeReviews != null ? ReviewWidget(reviewModel: productProvider.product!.activeReviews![index]) : const ReviewShimmer();
                  },
                ),
              ]),
      ],
            ...
            return Padding(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.radiusSizeTen), border: Border.all(color: Provider.of<CartProvider>(context, listen: false).productSelect == index ? Theme.of(context).primaryColor : ColorResources.getGreyColor(context), width: 1)),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(Dimensions.radiusSizeTen),
                    child: CustomImage(
