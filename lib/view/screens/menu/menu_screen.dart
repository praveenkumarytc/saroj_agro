...
class MenuWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: Provider.of<ThemeProvider>(context).darkTheme || ResponsiveHelper.isDesktop(context) ? Theme.of(context).hintColor.withOpacity(0.1) : Theme.of(context).primaryColor,
                                      ...
                                      leading: ClipOval(
                                        child: isLoggedIn
                                            ? Provider.of<SplashProvider>(context, listen: false).baseUrls != null
                                                ...
                                                : const SizedBox()
                                            : Image.asset(Images.getPlaceHolderImage(context), height: 50, width: 50, fit: BoxFit.cover),
                                      ),
                              ...
                              Column(
                                  children: screenList
                                      .map((model) => ListTile(
                                            ...
                                            title: Text(getTranslated(model.title, context),
                                                style: poppinsRegular.copyWith(
