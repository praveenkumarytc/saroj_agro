...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<bool?> _exitApp(BuildContext context) async {
    return showDialog(context: context, builder: (context) => CancelDialog(orderID: widget.orderId));
  }
}
...
class MyInAppBrowser extends InAppBrowser {
  ...
  MyInAppBrowser(this.context, {required this.orderId, int? windowId, UnmodifiableListView<UserScript>? initialUserScripts, this.fromCheckout}) : super(windowId: windowId, initialUserScripts: initialUserScripts);
