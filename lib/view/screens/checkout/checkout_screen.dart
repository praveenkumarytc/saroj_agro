...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: (ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(prefferedSized), child: WebAppBar()) : CustomAppBar(title: getTranslated('checkout', context))) as PreferredSizeWidget?,
      body: isRoute
          ? Column(children: [
              Expanded(
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          child: Row(
                                                                            children: [
                                                                              ...
                                                                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                              Text(
                                                                                '${DateConverter.stringToStringTime(orderProvider.timeSlots![index].startTime!, context)} '
