      ...
      child: Scaffold(
        ...
        body: Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
          return configModel.loyaltyPointStatus!
                                        ...
                                        Center(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                getTranslated('withdrawable_point', context),
                                              ...
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: tabButtonList
                                                      .map((tabButtonModel) => TabButtonView(
                                            ...
                                            child: Column(
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    if (walletProvider.selectedTabButtonIndex == 0) const ConvertMoneyView(),
                                                                ...
                                                                Column(children: [
                                                                  ...
                                                                  walletProvider.transactionList != null
                                                                      ? walletProvider.transactionList!.isNotEmpty
                                                                          ...
                                                                          : NoDataScreen(isFooter: false, title: getTranslated('no_result_found', context))
              ...
              : NoDataScreen(title: getTranslated('no_result_found', context));
        }),
      ),
    );
  }
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(15), border: Border.all(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.08))),
