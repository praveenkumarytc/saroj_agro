  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AuthProvider>(builder: (context, authProvider, _) {
      return Column(children: [
        Center(child: Text(getTranslated('sign_in_with', context), style: poppinsRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.6), fontSize: Dimensions.fontSizeSmall))),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              child: MediaButtonView(
                ...
                onTap: () async {
                  try {
                    ...
                    Provider.of<AuthProvider>(Get.context!, listen: false).socialLogin(
                        SocialLoginModel(
          ...
          if (!kIsWeb && defaultTargetPlatform == TargetPlatform.iOS && configModel.appleLogin != null && configModel.appleLogin!.status!)
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
              child: MediaButtonView(
