...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(prefferedSized), child: WebAppBar()) : null,
      body: SafeArea(
          child: Center(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(children: [
                                ...
                                Text(
                                  ...
                                  style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).hintColor.withOpacity(0.6)),
                                ),
                              ]),
                            ),
                          ),
                          InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor.withOpacity(0.6)),
                              ),
                            ),
                          ),
                        ]),
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          authProvider.loginErrorMessage!.isNotEmpty ? CircleAvatar(backgroundColor: Theme.of(context).colorScheme.error, radius: 5) : const SizedBox.shrink(),
                        ...
                        !authProvider.isLoading
                            ? CustomButton(
                                ...
                                onPressed: () async {
                                  ...
                                  } else if (Provider.of<SplashProvider>(context, listen: false).configModel!.emailVerification! && EmailChecker.isNotValid(email)) {
                        ...
                        if (socialStatus!.isFacebook! || socialStatus.isGoogle!) Center(child: SocialLoginWidget(countryCode: countryCode)),
