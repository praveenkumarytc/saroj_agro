    ...
    return Scaffold(
      ...
      body: _isLoggedIn
          ? configModel != null && configModel.walletStatus!
                      ...
                      ? Center(
                          ...
                          background: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                Container(
                                  constraints: ResponsiveHelper.isDesktop(context) ? const BoxConstraints() : BoxConstraints(maxHeight: ResponsiveHelper.isDesktop(context) ? MediaQuery.of(context).size.height : MediaQuery.of(context).size.height * 0.7),
              ...
              : NoDataScreen(title: getTranslated('not_found', context))
