class ConfigModel {
  ...
  ConfigModel({
    ...
    _maintenanceMode = maintenanceMode ?? false;
    _country = country;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _ecommerceLocationCoverage = json['ecommerce_location_coverage'] != null ? EcommerceLocationCoverage.fromJson(json['ecommerce_location_coverage']) : null;
    ...
    _deliveryManagement = json['delivery_management'] != null ? DeliveryManagement.fromJson(json['delivery_management']) : null;
    _playStoreConfig = json['play_store_config'] != null ? PlayStoreConfig.fromJson(json['play_store_config']) : null;
    _appStoreConfig = json['app_store_config'] != null ? AppStoreConfig.fromJson(json['app_store_config']) : null;
    ...
    _cookiesManagement = json['cookies_management'] != null ? CookiesManagement.fromJson(json['cookies_management']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_ecommerceLocationCoverage != null) {
      data['ecommerce_location_coverage'] = _ecommerceLocationCoverage!.toJson();
    }
...
class Branches {
  ...
  Branches({int? id, String? name, String? email, String? longitude, String? latitude, String? address, double? coverage}) {
    _id = id;
    _name = name;
    _email = email;
    _longitude = longitude;
...
class DeliveryManagement {
  ...
  DeliveryManagement({bool? status, double? minShippingCharge, double? shippingPerKm}) {
    _status = status;
